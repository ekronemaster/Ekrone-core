...
std::vector<AdvancedCommand> allCommands()
{
    return {
        ...
        AdvancedCommand("balance", "Display how much " + wallet_config::ticker + " you have", true, false),
        ...
        AdvancedCommand("transfer", "Send " + wallet_config::ticker + " to someone", false, false),
        ...
        AdvancedCommand("ab_send", "Send " + wallet_config::ticker + " to someone in your address book", false, true),
