...
// Copyright (c) 2017-2023 Ekrone Gold Developers
...
namespace {
  ...
  const command_line::arg_descriptor<uint64_t>    arg_threshold = {"threshold", "Only outputs lesser than the threshold value will be included into optimization. Default: 100 (0.000100 ekrone)", DEFAULT_THRESHOLD, true};
