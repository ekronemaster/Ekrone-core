...
namespace cn
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 630196; /* ekr address prefix */
		...
		const uint8_t ZAWY_DIFFICULTY_BLOCK_VERSION = 3;
		...
		const uint64_t MINIMUM_FEE = UINT64_C(10);			  /* 0.000010 EKR */
		const uint64_t MINIMUM_FEE_V1 = UINT64_C(100);		  /* 0.000100 EKR*/
		const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000);		  /* 0.001000 EKR */
		const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000);  /* 0.001000 EKR */
		const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 EKR */
		...
		const uint64_t UPGRADE_HEIGHT_V7 = 195765;	  /* Cryptoight Ekrone */
		...
		const uint64_t TESTNET_UPGRADE_HEIGHT_V7 = 60;	  /* Cryptoight Ekrone */
	...
	const uint64_t REWARD_INCREASE_INTERVAL = (UINT64_C(21900));			   // aprox. 1 month (+ 0.25 EKR increment per month)

	const char BLOCKCHAIN_DIR[] = "ekrone";
	const char GENESIS_COINBASE_TX_HEX[] = "010a01ff0001c096b102029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210131e3085e97ed3be6b60a21f4283572173375325f965f44146b61b9beb581c93d";
	...
	const uint8_t BLOCK_MAJOR_VERSION_7 = 7; /* Cryptonight Ekrone */
	...
	const int RPC_DEFAULT_PORT = 23898;
    const int PAYMENT_GATE_DEFAULT_PORT = 6070;

	const int TESTNET_P2P_DEFAULT_PORT = 23497;
	const int TESTNET_RPC_DEFAULT_PORT = 23498;
    const int TESTNET_PAYMENT_GATE_DEFAULT_PORT = 6770;
