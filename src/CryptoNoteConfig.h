...
// Copyright (c) 2018-2023 Ekrone Infinity Developers
//
...
const uint64_t MINIMUM_FEE 					= UINT64_C(1000); /* 0.001000 Ekr */
...
const uint64_t REWARD_INCREASE_INTERVAL 			= (UINT64_C(22000)); // aprox. 1 month (+ 0.25 Ekr increment per month)
...
const uint64_t GENESIS_TIMESTAMP 				    = 1691833961;
