...
// Copyright (c) 2018-2023 Ekrone Gold Developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX 		= 630196; /* Ekrone address prefix */
...
const uint64_t MINIMUM_FEE 					= UINT64_C(1000); /* 0.001000 ekrone */
const uint64_t MINIMUM_FEE_BANKING 				= UINT64_C(1000); /* 0.001000 ekrone */
const uint64_t DEFAULT_DUST_THRESHOLD 				= UINT64_C(10); /* 0.000010 ekrone */  
...
const uint64_t REWARD_INCREASE_INTERVAL 			= (UINT64_C(22000)); // aprox. 1 month (+ 0.25 ekrone increment per month)
