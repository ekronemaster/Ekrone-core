...
// Copyright (c) 2018-2023, The Ekrone Developers
//
...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const double MINIMUM_FEE_PER_BYTE_V1 = 204800 / FEE_PER_BYTE_CHUNK_SIZE;
        ...
        const uint64_t MAX_OUTPUT_SIZE_NODE   = 250'000'000'000'000;

        const uint64_t MAX_OUTPUT_SIZE_CLIENT = 100'000'000'000'000;
        ...
        const size_t NORMAL_TX_MAX_OUTPUT_COUNT_V1 = 210;
    ...
    const char CRYPTONOTE_NAME_TEXT[] = "Ekrone";
    ...
    const char LATEST_VERSION_URL[] = "https://ekrone.eu";

    const std::string LICENSE_URL = "https://github.com/Ekrone/ekrone/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0x9e, 0x42, 0x04, 0x22, 0x45, 0xdb, 0x11, 0x03, 0x38, 0xbd, 0x96, 0x13, 0x41, 0x32, 0xbd, 0x11}};
