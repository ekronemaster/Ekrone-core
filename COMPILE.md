...
-   `export CC=gcc-8`
-   `export CXX=g++-8`
-   `git clone -b master --single-branch https://github.com/Ekrone/ekrone`
-   `cd ekrone`
-   `mkdir build`
-   `cd build`
-   `cmake ..`
...
-   `cd ..`
-   `git clone https://github.com/Ekrone/ekrone/`
-   `mkdir -p ekrone/build`
-   `cd ekrone/build`
-   `cmake3 ..`
-   `make`
...
-   `MSBuild Ekrone.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild Ekrone.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`
...
[^ Return To Top](#compiling-ekrone-cash)
